...
<%
	...
	'jsonText = "{""IM_USER"":""{\""MBR_NO\"":\""9999000000857\""}"",""VIRTUAL_BRAND_CODE"":""3000"",""SERVER_API_SEQ"":""39"",""OPERATION_MODE"":""dev""}"
	...
	'해시코드 및 기본정보 대사처리 <=====> IM
	Call checkIm(params,"requestDrop")

	'IM_USER 정보 처리
	Dim imQuery
	imQuery = requestDropImUserQuery(jsonData)

	'프로시저 처리
	Call executeProcedure("up_NAdaptor_disableUser", imQuery)
